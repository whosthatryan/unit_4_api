...
class GuitarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guitar" do
    assert_difference('Guitar.count') do
      post guitars_url, params: { guitar: { brand: @guitar.brand, model: @guitar.model, type: @guitar.type, year: @guitar.year } }, as: :json
    end
  ...
  test "should update guitar" do
    patch guitar_url(@guitar), params: { guitar: { brand: @guitar.brand, model: @guitar.model, type: @guitar.type, year: @guitar.year } }, as: :json
    assert_response 200
  end
